...
console.log(color(figlet.textSync('ZizuGanteng', {
		font: 'Pagga',
...
console.log(color('\n🐶 YT CHANNEL: Zizu ','silver'))
console.log(color('🐶 GITHUB: ZIZUHENSEM ','silver'))
console.log(color('🐶 WA NUMBER: +6281352410020 ','silver'))
console.log(color('  🦄ZizuBotz Inc. 2022🦄','mediumseagreen'))
